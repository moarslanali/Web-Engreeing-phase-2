...
$query = "SELECT * FROM tblproducts WHERE ProductInStock='Yes' ORDER BY id desc";
 ...
 <div class="container site-section" id="welcome">
        ...
        while ($row = mysqli_fetch_array($run)) 
        {
            ...
            <div class='col-md-4 col-sm-12'>
                <div class='card'><a href='uploads/".$row['ProductImage']."' target='_blank' data-lightbox='cakes'><img class='img-fluid' src='uploads/".$row['ProductImage']."'></a>
                    <div class='card-body'>
                        <big class='card-text'><a href='ProductDetail.php?ID=".$row['ID']."'><b>".$row['ProductName']."</b></a></big>
                        <div><a href='ProductDetail.php?ID=".$row['ID']."'class='btn btn-sm btn-success'>Details</a>
                        </div>
                    </div>
                </div>
            </div>
