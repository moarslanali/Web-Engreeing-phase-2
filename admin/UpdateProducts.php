    ...
    <div class="container site-section" id="welcome">
        ...
        while ($row = mysqli_fetch_array($run)) 
        {
            ...
            <div class='col-md-4 col-sm-12'>
                <div class='card'><a href='assets/img/cupcakes.jpg' target='_blank' data-lightbox='cakes'><img class='img-fluid' src='assets/img/cupcakes.jpg'></a>
                    <div class='card-body'>
                        <big class='card-text'><a href='../ProductDetail.php?ID=".$row['ID']."'><b>".$row['ProductName']."</b></a></big>
                        <div><a href='UpdateProduct.php?ID=".$row['ID']."'class='btn btn-sm btn-success'>UPDATE</a>
                        </div>
                    </div>
                </div>
            </div>
